...
@section('title')
    {!! trans('system.action.view') !!} - {!! trans('staffs.label') !!}
@stop
@section('head')
...
@section('content')
    ...
    <div style="margin-left: 45%;padding-top: 2%">
        {!! HTML::link(route( 'admin.staffs.index' ), trans('system.action.return'), ['class' => 'btn btn-danger btn-flat back','id'=>'cancel']) !!}
    </div>
@stop
@section('footer')
    ...
    <script>
        $('.box-staff input, .box-staff select').prop('disabled', true)
        $('.box-staff a.btn:not(".back")').attr('disabled', true).change()
        $('.box-staff a.btn:not(".back")').on('click', function () {
            return false;
        })
