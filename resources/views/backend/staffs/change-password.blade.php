...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{!! route('admin.staffs.index') !!}">{!! trans('users.label') !!}</a></li>
        </ol>
    </section>
    <section class="content overlay">
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                @endif
                {!! Form::open(['role' => 'form', 'method' => 'PUT', 'url' => route('admin.staffs.update_password_put', $staffs->id)]) !!}
                    <table class='table'>
                        <tr>
                        ...
                        <tr >
                            ...
                            <td colspan="4" align="center">
                                {!! HTML::link(route('admin.staffs.index'), trans('system.action.cancel'), array('class' => 'btn btn-default btn-flat'))!!}
