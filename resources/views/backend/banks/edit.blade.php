...
@section('title')
    {!! trans('system.action.edit') !!} - {!! trans('banks.label') !!}
@stop
@section('head')
...
@section('content')
    ...
    @endif
    {!! Form::open([ 'url' => route('admin.banks.update', $bank->id), 'method' => 'PUT', 'role' => 'form', 'files' => true ]) !!}
        <table class='table borderless'>
            <tr>
                ...
                <td style="width: 30%;">
                    {!! Form::text('name', old('name', $bank->name), array('class' => 'form-control', 'required', 'maxlength' => 100, 'id' => 'name')) !!}
                </td>
                <th class="text-right" style="width: 20%;">
                    {!! trans("banks.logo") !!}
                </th>
            ...
            <tr>
                ...
                <td>
                    {!! Form::select('type', $types, old('type', $bank->type), array('class' => 'form-control', 'required', 'maxlength' => 100)) !!}
                </td>
            </tr>
            <tr>
                <th class="text-right">
                ...
                <td>
                    {!! Form::select('gateway', [ '' => trans('system.dropdown_choice') ] + $gateways, old('gateway', $bank->gateway_id), array('class' => 'form-control', 'required', 'maxlength' => 100)) !!}
                </td>
            </tr>
            <tr>
                <th class="text-right">
                ...
                <td>
                    {!! Form::text('code', old('code', $bank->code), array('class' => 'form-control', 'required', 'maxlength' => 15)) !!}
                </td>
            </tr>
            <tr>
                <th class="text-right">
                ...
                <td>
                    {!! Form::text('fee_fixed', old('fee_fixed', $bank->fee_fixed), array('class' => 'form-control amount', 'required')) !!}
                </td>
                <th class="text-right">
                    {!! trans('banks.fee_percent') !!}
                </th>
                <td>
                    {!! Form::text('fee_percent', old('fee_percent', $bank->fee_percent), array('class' => 'form-control decimal', 'required')) !!}
                </td>
            </tr>
            <tr>
                <th class="text-right">
                ...
                <td>
                    {!! Form::text('raw_fee_fixed', old('raw_fee_fixed', $bank->raw_fee_fixed), array('class' => 'form-control amount', 'required', 'disabled')) !!}
                </td>
                <th class="text-right">
                    {!! trans('banks.raw_fee_percent') !!}
                </th>
                <td>
                    {!! Form::text('raw_fee_percent', old('raw_fee_percent', $bank->raw_fee_percent), array('class' => 'form-control decimal', 'required', 'disabled')) !!}
                </td>
            </tr>
            <tr>
                <th class="text-center" colspan="4">
                    <label>
                        {!! Form::checkbox('status', 1, old('status', $bank->status), [ 'class' => 'minimal' ]) !!}
                        {!! trans('banks.online') !!}
                    </label>
                    {{-- &nbsp;&nbsp;&nbsp;&nbsp;
                    <label>
                        {!! Form::checkbox('qr_code', 1, old('qr_code', $bank->qr_code), [ 'class' => 'minimal-red' ]) !!}
                        {!! trans('banks.qr_code') !!}
                    </label> --}}
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <label>
                        {!! Form::checkbox('is_partner', 1, old('is_partner', $bank->is_partner), [ 'class' => 'minimal' ]) !!}
