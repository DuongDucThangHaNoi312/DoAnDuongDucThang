...
@section('title')
    {!! trans('system.action.create') !!} - {!! trans('staff_positions.label') !!}
@stop
@section('head')
...
@section('content')
    ...
    {!! Form::open(['url' => route('admin.positions.store'),'method'=>'POST','role' => 'form']) !!}
    <div style="margin-left: 20%;margin-top: 2%">
        <table class='table borderless'>
                ...
                <tr>
                    ...
                    <td>
                        {!! Form::text('name', old('name'), ['class' => 'form-control', 'maxlength' => 13,  'required']) !!}
                    </td>
                </tr>
                <tr>
                    <td class="text-center table_right_middle1" colspan="3">
                        <label>
                            {!! Form::checkbox('unique_in_dept',1, old('unique_in_dept'), [ 'class' => 'minimal' ]) !!}
