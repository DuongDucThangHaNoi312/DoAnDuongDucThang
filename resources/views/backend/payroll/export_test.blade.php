            ...
            <tbody>
               ...
               <?php $pc_di_lai = $pc_trach_nhiem = $pc_cong_hien = $pc_ns_cong_viec = $pc_dien_thoai = $pc_dac_thu = $pc_khac = $pc_chuyen_can = 0; ?>
                @foreach ($payroll_detail as $k => $item)  
                    ...
                    <tr class="hover" data-index="{{ $k + 1 }}">
                        ...
                        <td style="text-align: center; vertical-align: middle; border: 1px solid black;">
                            {{ \App\StaffDayOff::countDayOffs($item->user_id, $payroll->month, $payroll->year, 'T', $item->timekeepingDetail->timekeeping->department_id) }}
                        </td>
                        <td style="text-align: center; vertical-align: middle; border: 1px solid black;">
                            {{ \App\Models\Payroll::countTotalInMonthForTimeKeeping($item->user_id, $payroll->month, $payroll->year, $item->timekeepingDetail->timekeeping->department_id) }}
                        </td>
                        <td style="text-align: center; vertical-align: middle; border: 1px solid black;">
                            {{ \App\StaffDayOff::countDayOffs($item->user_id, $payroll->month, $payroll->year, 'C', $item->timekeepingDetail->timekeeping->department_id) }}
                        </td>
                        <td style="text-align: center; vertical-align: middle; border: 1px solid black;">
                            {{ \App\Models\Payroll::nghiKhongLuong($item->user_id, $payroll->month, $payroll->year, 'O', $item->timekeepingDetail->timekeeping->department_id) }}
                        </td>
                        <td style="text-align: center; vertical-align: middle; border: 1px solid black;">
                            {{ $totalWorkDepartment ?? '' }}
                        </td>
                        ...
                        @foreach ($cate_allowances as $k1 => $cate)
                            ...
                            <?php 
                                $tt = intval(str_replace(".","", (String)\App\Models\Payroll::calculateAllowance($item->user_id, $k1, $totalDayRequest, $totalWorkDepartment, $payroll->month, $payroll->year, $item->salary_concurrent, '', $payroll->department_id)));
                        ...
                        <td style="text-align: center; vertical-align: middle; border: 1px solid black;">
                            {{ \App\Models\Payroll::getKpi($item->user_id, $payroll->month, $payroll->year) ?? '0' }}
                        </td>
                        <td style="text-align: center; vertical-align: middle; border: 1px solid black;">
               ...
               <tr>
                    ...
                    @for ($i = 1; $i <= 55; $i++)
                        @if ($i == 2)
                         ...
                         @elseif ($i == 16)
                            <td style="text-align: center; vertical-align: middle; background: #e5c3ce; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'basic_salary_tv')))?? '' !!}
                            </td>
                        @elseif ($i == 17)
                            <td style="text-align: center; vertical-align: middle; background: #e5c3ce; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'basic_salary_hd')))?? '' !!}
                            </td>
                        @elseif ($i == 18)
                            <td style="text-align: center; vertical-align: middle; background: #e5c3ce; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'salary_bh')))?? '' !!}
                            </td>
                        @elseif ($i == 19)
                            <td style="text-align: center; vertical-align: middle; background: #e5c3ce; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'working_salary_tax')))?? '' !!}
                            </td>
                        @elseif ($i == 20)
                            <td style="text-align: center; vertical-align: middle; background: #e5c3ce; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'working_salary_non_tax')))?? '' !!}
                            </td>

                        @elseif ($i == 21)
                            <td style="text-align: center; vertical-align: middle; background: #e5c3ce; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'salary_ot_non_tax')))?? '' !!}
                            </td>
                        @elseif ($i == 22)
                            <td style="text-align: center; vertical-align: middle; background: #e5c3ce; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'salary_ot_tax')))?? '' !!}
                            </td>
                        @elseif ($i == 23)
                            <td style="text-align: center; vertical-align: middle; background: #e5c3ce; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'food_allowance_nonTax')))?? '' !!}
                            </td>

                        @elseif ($i == 24)
                            <td style="text-align: center; vertical-align: middle; background: #e5c3ce; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'food_allowance_tax')))?? '' !!}
                            </td>
                        @elseif ($i == 25)
                            <td style="text-align: center; vertical-align: middle; background: #e5c3ce; border: 1px solid black;">
                        ...
                        @elseif ($i == 34)
                            <td style="text-align: center; vertical-align: middle; background: #e5c3ce; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'total_salary')))?? '' !!}
                            </td>
                        @elseif ($i == 35)
                        ...
                        @elseif ($i == 44)
                            <?php 
                                $total_deduction = array_sum(array_column($payroll_detail->toArray(), 'total_deduction'));
                                $total_deduction_tax = array_sum(array_column($payroll_detail->toArray(), 'total_deduction_tax'));
                            ?>
                            <td style="text-align: center; vertical-align: middle; background: #cca0ae; border: 1px solid black;">
                        ...
                        @elseif ($i == 45) 
                            <td style="text-align: center; vertical-align: middle; background: #cca0ae; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'total_deduction_tax')))?? '' !!}
                            </td>  
                        @elseif ($i == 46)
                            <?php 
                                $total_payoff = array_sum(array_column($payroll_detail->toArray(), 'total_payoff'));
                                $total_payoff_tax = array_sum(array_column($payroll_detail->toArray(), 'total_payoff_tax'));
                            ?>
                            <td style="text-align: center; vertical-align: middle; background: #cca0ae; border: 1px solid black;">
                        ...
                        @elseif ($i == 47)
                            <td style="text-align: center; vertical-align: middle; background: #cca0ae; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'total_payoff_tax')))?? '' !!}
                            </td>  
                        @elseif ($i == 48)
                            <td style="text-align: center; vertical-align: middle; background: #cca0ae; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'income_taxes')))?? '' !!}
                            </td> 
                        
                        @elseif ($i == 50)
                            <td style="text-align: center; vertical-align: middle; background: #cca0ae; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'family_allowances')))?? '' !!}
                            </td> 
                        @elseif ($i == 51)
                            <td style="text-align: center; vertical-align: middle; background: #cca0ae; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'taxable_income')))?? '' !!}
                            </td>  
                        @elseif ($i == 52)
                            <td style="text-align: center; vertical-align: middle; background: #cca0ae; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'personal_income_tax')))?? '' !!}

                            </td>  
                        @elseif ($i == 55)
                            <td style="text-align: center; vertical-align: middle; background: #cca0ae; border: 1px solid black;">
                                {!! number_format(array_sum(array_column($payroll_detail->toArray(), 'total_real_salary')))?? '' !!}
                            </td>  
                        @else   
