            ...
            @permission('payrolls.create')
                ...
                <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        {!! Form::open(['id' => 'tinh_lai', 'url' => route('admin.payroll.store1'), 'method' => 'POST', 'target' => "_blank"]) !!}
                ...
                <a href="{{ route('admin.payroll.exportExcel', $payroll->id) }}" class="btn btn-success" target="_blank">
                           ...
                           <?php $i = 1; ?>
                            @foreach ($payroll_details as $k => $item)
                                ...
                                <tr class="hover" data-index="{{ $k + 1 }}">
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        <input  name="ca_ngay_tv[]" style="text-align: center;" type="text" value="{{ $item->tongHop['ngay_tv'] ?? 0 }}" data-name="default" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct">
                                    </td>
                                    <td style="text-align: center; vertical-align: middle;">
                                        <input  name="ca_ngay_hd[]" style="text-align: center;" type="text" value="{{ $item->tongHop['ngay_hd'] ?? 0 }}" data-name="default" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct">
                                    </td>
                                    <td style="text-align: center; vertical-align: middle;">
                                        <input  name="ca_dem_tv[]" style="text-align: center;" type="text" value="{{ $item->tongHop['dem_tv'] ?? 0 }}" data-name="default" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct">
                                    </td>
                                    <td style="text-align: center; vertical-align: middle;">
                                        <input  name="ca_dem_hd[]" style="text-align: center;" type="text" value="{{ $item->tongHop['dem_hd'] ?? 0 }}" data-name="default" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct">
                                    </td>
                                    <td style="text-align: center; vertical-align: middle;">
                                        <input  name="count_day_offs[]" style="text-align: center;" type="text" value="{{ $item->tongHop['nghi_cong_tac'] ?? 0 }}" data-name="default" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct">
                                    </td>
                                    <td style="text-align: center; vertical-align: middle;">
                                        <?php 
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        <input  name="ngaydinhchi[]" style="text-align: center;" type="text" value="{{ $item->tongHop['nghi_70_luong'] ?? 0 }}" data-name="default" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct">
                                    </td>
                                    <td  style="text-align: center; vertical-align: middle;">
                                        <?php 
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        <input  name="tong[]" type="text" style="width: 70px;text-align: center;" value="{{ $item->tongHop['total'] ?? 0 }}" data-name="total_work_department" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct">
                                    </td>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        <input  name="an_chinh[]" style="text-align: center;" type="text" value="{{ $item->tongHop['an_chinh'] ?? 0 }}" data-name="an_chinh" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct">
                                    </td>
                                    <td style="text-align: center; vertical-align: middle;">
                                        <input  name="an_phu[]" style="text-align: center;" type="text" value="{{ $item->tongHop['an_phu'] ?? 0 }}" data-name="an_phu" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct">
                                    </td>
                                    {{-- <td style="text-align: center; vertical-align: middle;">
                                    ...
                                    @foreach ($cate_allowances as $k1 => $cate)
                                        <td style="text-align: center; vertical-align: middle;" class="tdbreak">
                                            ...
                                            <input name="trocap_{!! $k1 !!}[]" style="text-align: right;width:100%" type="text" value="{!! intval($item->calculateAllowance[$k1]) ?? 0 !!}" data-name="allowance" 
                                    ...
                                    <td style="text-align: right; vertical-align: middle;">
                                        <input name="bhxh_user[]" style="width: 150px ;text-align: right;" type="text" value="{!! intval($item->bh['bhxh_user'])?? '' !!}"  
                                        data-name="bhxh_user" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct bhxh_user currency">
                                    </td>
                                    <td style="text-align: right; vertical-align: middle;">
                                        <input name="bhyt_user[]" style="width: 150px;text-align: right;" type="text" value="{!! intval($item->bh['bhyt_user'])?? '' !!}" 
                                        data-name="bhyt_user" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct bhyt_user currency">
                                    </td>
                                    <td style="text-align: right; vertical-align: middle;">
                                        <input name="union_user[]" style="width: 150px;text-align: right;" type="text" value="{!! intval($item->bh['union_user'])?? '' !!}" 
                                        data-name="union_user" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct union_user currency">
                                    </td>
                                    <td style="text-align: right; vertical-align: middle;">
                                        <input name="bhtn_user[]" style="width: 150px;text-align: right;" type="text" value="{!! intval($item->bh['bhtn_user'])?? '' !!}" 
                                        data-name="bhtn_user" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct bhtn_user currency">
                                    </td>
    
                                    <td style="text-align: right; vertical-align: middle;">
                                        <input name="bhxh_company[]" style="width: 150px;text-align: right;" type="text" value="{!! intval($item->bh['bhxh_company'])?? '' !!}" 
                                        data-name="bhxh_company" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct bhxh_company currency" >
                                    </td>
    
                                    <td style="text-align: right; vertical-align: middle;">
                                        <input name="bhyt_company[]" style="width: 150px;text-align: right;" type="text" value="{!! intval($item->bh['bhyt_company'])?? '' !!}" 
                                        data-name="bhyt_company" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct bhyt_company currency">
                                    </td>
                                    <td style="text-align: right; vertical-align: middle;">
                                        <input name="union_company[]" style="width: 150px;text-align: right;" type="text" value="{!! intval($item->bh['union_company'])?? '' !!}" 
                                        data-name="union_company" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct union_company currency">
                                    </td>
    
                                    <td style="text-align: right; vertical-align: middle;">
                                        <input name="bhtn_company[]" style="width: 150px;text-align: right;" type="text" value="{!! intval($item->bh['bhtn_company'])?? '' !!}" data-name="bhtn_company" 
                                    ...
                                    <td style="text-align: right; vertical-align: middle;">
                                        <input name="get_kpi[]" style="text-align: center;" type="text" value="{{ $item->tongHop['total'] == 0 ? 0 : \App\Models\Payroll::getKpi($item->user_id, $payroll->month, $payroll->year) }}" data-name="kpi" data-user-id="{!! $item->user_id !!}" name="" id="" class="form-control ct ">
                                    </td>
                                    <td style="text-align: right; vertical-align: middle;">
...
<script src="{!! asset('assets/backend/plugins/input-mask/jquery.inputmask.min.js') !!}"></script>
    ...
    <script>
        $(function() {
            $('.action').hide();
            var ids = [];
            var count = {{ count($payroll_details) }};

            $('.check-all').on('click', function() {
                $(this).attr('checked', 'checked');
                if (this.checked == true) {
                    $('.type-check').attr('checked', 'checked');
                    ids = [{{ implode(',', array_pluck($payroll_details, 'id')) }}];
                    $('.action').show();
                } else {
