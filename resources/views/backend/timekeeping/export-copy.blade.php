    ...
    <table class="table table-striped table-bordered">
        <thead>
            <tr>
                ...
                <th style="border: 1px solid black ; font-family:Arial, Helvetica; vertical-align: center;text-align :center;" align="center" width="10" colspan="7">{!! trans('timekeeping.day_off_number') !!}</th>
            ...
            @if (count($items) > 0)  
                ...
                <tr>
                    ...
                    @foreach ($item->detail as $k => $v)
                        ...
                        {{-- <td align="center" style="border: 1px solid black ;background: {{  $getDays[$i] == 'Sun' ? '#4dd7d7' : '' }};" >
                        ...
                        <td style="background: {{  $getDays[$i] == 'Sun' ? '#4dd7d7' : '' }}; padding: 0; border: 1px solid black; font-family:Arial, Helvetica; font-size:9px; text-align: center; vertical-align: center;">
                            <?php $holiday = \App\StaffDayOff::selectDayOff($workSchedule, $nghi_phong_ban, $nghi_nhan_vien, $item->staff_id, date('Y-m-d', $k)); ?>

                            @if (in_array($holiday, ['H', 'L', 'T', 'O', 'W', 'D', 'BB']))
                                {{ $holiday }}<br>
                            @else   
                                ...
                                <?php 
                                    ...
                                    } else if ($holiday != '' && ($v['total'] == 0 || $v['total'] == null)) {
                                        echo $holiday;
                                    } else if ($holiday != '' && $v['total'] > 0) {
                                        echo '<br>';
                                        echo $holiday;
                                    }
                                ?>
                    ...
                    @endforeach
                    <td style="border: 1px solid black ;font-family:Arial, Helvetica;text-align: center; vertical-align: center;" align="center" class="">{!! $total_day_request !!}</td>
                    ...
                    <td style="border: 1px solid black ;font-family:Arial, Helvetica; text-align: center; vertical-align: center;" align="center" class="">{{ \App\StaffDayOff::countDayOffs($item->staff_id, $item->timekeeping->month, $item->timekeeping->year, 'C') }}</td>
                    <td style="border: 1px solid black ;font-family:Arial, Helvetica; text-align: center; vertical-align: center;" align="center" class="">{{ \App\StaffDayOff::countDayOffs($item->staff_id, $item->timekeeping->month, $item->timekeeping->year, 'S') }}</td>
                    <td style="border: 1px solid black ;font-family:Arial, Helvetica;text-align: center; vertical-align: center;" align="center" class="">{{ \App\StaffDayOff::countDayOffs($item->staff_id, $item->timekeeping->month, $item->timekeeping->year, 'O') + $item->nghi_k_xin }}</td>
                    <td style="border: 1px solid black ;font-family:Arial, Helvetica;text-align: center; vertical-align: center;" align="center" class="">{{ \App\StaffDayOff::countDayOffs($item->staff_id, $item->timekeeping->month, $item->timekeeping->year, 'W') }}</td>
                    <td style="border: 1px solid black ;font-family:Arial, Helvetica;text-align: center; vertical-align: center;" align="center" class="">{{ \App\StaffDayOff::countDayOffs($item->staff_id, $item->timekeeping->month, $item->timekeeping->year, 'D') }}</td>
                    <td style="border: 1px solid black ;font-family:Arial, Helvetica;text-align: center; vertical-align: center;" align="center" class="">{{ \App\StaffDayOff::countDayOffs($item->staff_id, $item->timekeeping->month, $item->timekeeping->year, 'L') }}</td>
                    <td style="border: 1px solid black ;font-family:Arial, Helvetica;text-align: center; vertical-align: center;" align="center" class="">{{ \App\StaffDayOff::countDayOffs($item->staff_id, $item->timekeeping->month, $item->timekeeping->year, 'T') }}</td>
