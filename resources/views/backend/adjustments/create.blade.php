...
@section('content')
    ...
    <section class="content overlay">
        <div class="box box-primary">
            {!! Form::open(['url' => route('admin.adjustments.store'), 'role' => 'form', 'method'=>'POST']) !!}
                <div class="row" style="margin-top: 20px">
                    <div class="col-md-8">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6" style="text-align: right">
                                    <label for="code"class='control-label'>{!! trans('adjustments.code') !!}</label>
                                </div>
                                <div class="col-md-6">
                                    <input id="code" name="code" type="text" value="{{ old('code') }}" class="form-control" required placeholder="{!! trans('staffs.code_placeholder') !!}" >
                                    <span style="color:red" id="inputCode"></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <td>
                                    {!! Form::select('type', ['' => trans('system.adjustment_type')] + \App\Defines\Adjustment::getAdjustmentTypesForOption(), old('type'), ['class' => 'form-control select2', 'required']) !!}
                                    </td>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    {!! Form::select('status', ['' => trans('system.tax_status')] + \App\Defines\Adjustment::getTaxStatusForOption(), old('status'),  ['class' => 'form-control select2 currency', 'required']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6" style="text-align: right">
                                    <label for="">{!! trans('adjustments.amount_money') !!} </label>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group">
                                        {!! Form::text('amount',old('amount'), ["class" => "form-control", 'autocomplete' => 'off']) !!}
                ...
                <div class="form-group" style="text-align: center; margin-top: 10px;">
                    ...
                    <input type="checkbox" name="action" class="minimal" value="1" checked>
                </div>
                <div class="form-group" style="text-align: center">
                    <a href="{{ route('admin.adjustments.index') }}" class="btn btn-danger btn-flat">Trở lại</a>
