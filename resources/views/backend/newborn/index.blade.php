...
@section('title')
    {!! trans('system.action.list') !!} Chế độ con nhỏ
@stop
@section('head')
...
@section('content')
    ...
    <section class="content overlay">
        <div class="row">
            <div class="col-md-2">
               <a href="{!! route('admin.newborns.create') !!}" class='btn btn-primary btn-flat'>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered" id="tableOT">
                            ...
                            <tr>
                                ...
                                <th style="text-align: center; vertical-align: middle;">Số giờ làm việc</th>
                                <th style="text-align: center; vertical-align: middle;">Ngày bắt đầu</th>
                                <th style="text-align: center; vertical-align: middle;">Ngày kết thúc</th>
                                <th style="text-align: center; vertical-align: middle;">Người tạo</th>
                                <th style="text-align: center; vertical-align: middle;">{!! trans('system.action.label') !!}</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach ($newborns as $key => $item)
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;" class="text-center">{!! $item->time ?? '' !!}</td>
                                    <td style="vertical-align: middle;" class="text-center">{!! date('d/m/Y', strtotime($item->start)) ?? '' !!}</td>
                                    <td style="vertical-align: middle;" class="text-center">{!! date('d/m/Y', strtotime($item->end)) ?? '' !!}</td>
                                    <td style="vertical-align: middle;" class="text-center">{!! $item->createdBy->fullname ?? '' !!}</td>
                                    <td style="text-align: center; vertical-align: middle; white-space: nowrap;">&nbsp;&nbsp;
                                        <a href="{!! route('admin.newborns.edit', $item->id) !!}"
                                       ...
                                       <a href="javascript:void(0)"
                                          link="{!! route('admin.newborns.destroy', $item->id) !!}"
