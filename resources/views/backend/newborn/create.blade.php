    ...
    <div style="width: 700px; margin: auto; margin-top: 50px;">
        ...
        <div class="box-body">
            <div>
                ...
                <select name="user_id" id="" class="form-control select2 userSelect"></select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class='input-group'>
                                {!! Form::text('end', old('end'), ['class' => 'form-control datepicker','id'=>'end_date','autocomplete'=>'off']) !!}
                                <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                            </div>
...
@section('footer')
    ...
    <script>
        ...
        $('body').on('click', '#submitForm', function(){
            ...
            $.ajax({
                url: "{!! route('admin.newborns.store') !!}",
                type: "POST",
