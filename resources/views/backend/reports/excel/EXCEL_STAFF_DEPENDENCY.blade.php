<table class="table table-bordered" style="width: 100%" id="data">
    <thead>
        <tr style="background-color: #92D050;">
            ...
            <td align="center" valign="middle" width="20" style="border: 1px solid #000000; text-transform: uppercase; white-space: nowrap;"><b>Mã Nhân viên
            </b></td>
            <td align="center" valign="middle" width="20" style="border: 1px solid #000000; text-transform: uppercase; white-space: nowrap;"><b>Nhân viên
            </b></td>
