...
@section('title')
{!! trans('system.action.import') !!} - {!! trans('contracts.label') !!}
@stop
@section('head')
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <p class="help-block">Tải file theo định dạng sau <a href="{!! route('admin.contracts.downloadExcel') . '?time=' . time() !!}">tại đây</a></p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
...
<script>
    ...
    function upload() {
        ...
        // NProgress.start();
        $.ajax({
            url: "{!! route('admin.contracts.read-bulk') !!}",
            data: myfile,
            type: 'POST',
            contentType: false,
            processData: false,
    ...
    function save() {
        ...
        // NProgress.start();
        $.ajax({
            url: "{!! route('admin.contracts.save-bulk') !!}",
            data: { data: data },
            type: 'POST',
            datatype: 'json',
            headers: {'X-CSRF-Token': "{!! csrf_token() !!}"},
