    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered expense">
                ...
                <tbody>
                <?php $allowance_cat = old('allowance_cat', $allowanceDept ? $allowanceDept->pluck('id') : []);?>
                @if (count($allowance_cat))
                    <?php
                    $desc = old('desc', $allowanceDept->pluck('desc'));
                    ...
                    @for ($i = 0; $i < count($allowance_cat); $i++)
                        <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle;">
                                {!! Form::text("allowance_cost[$i]", old("allowance_cost[$i]", $allowance_cost[$i]), ['class' => 'form-control currency ']) !!}
                            </td>
                ...
                @else
                    <tr>
                        ...
                        <td style="text-align: center; vertical-align: middle;">
                            {!! Form::text('allowance_cost[]', old('allowance_cost[]'), ['class' => 'form-control currency appendix_allowance_cost_new']) !!}
                        </td>
                        <td style="vertical-align: middle;">
