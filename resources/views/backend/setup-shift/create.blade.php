...
@section('content')
    ...
    <section class="content overlay">
        <div class="box box-primary">
            ...
            {!! Form::open(['url' => route('admin.setupshifts.store'), 'method'=>'POST']) !!}
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="shortened_name" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-check disabled">
                                        <input class="form-check-input" type="radio" name="type" id="type3" value="2" required>
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type" id="type2" value="3" required>
