    ...
    */
    ...
    'connections' => [
        ...
        'mysql_booking' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_BOOKING', '127.0.0.1'),
            'port' => env('DB_PORT_BOOKING', '3306'),
            'database' => env('DB_DATABASE_BOOKING', 'forge'),
            'username' => env('DB_USERNAME_BOOKING', 'forge'),
        ...
        'db_accounting' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_ACCOUNTING', '127.0.0.1'),
            'port' => env('DB_PORT_ACCOUNTING', '3306'),
            'database' => env('DB_DATABASE_ACCOUNTING', 'forge'),
            'username' => env('DB_USERNAME_ACCOUNTING', 'forge'),
